...
DATA_GENERATOR_PATH = PROJECT_PATH + "external/sdgen.jar"
DATA_CHARACTERIZATIONS_PATH = PROJECT_PATH + "external/sdgen_characterizations/"
FS_SNAPSHOT_PATH = PROJECT_PATH + "output/"
DIRECTORY_DEPTH_PROBABILITY = 0.1
FS_IMAGE_PATH = PROJECT_PATH + "external/impressions"
FS_IMAGE_CONFIG_PATH = PROJECT_PATH + "external/impressions_config"