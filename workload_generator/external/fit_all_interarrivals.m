function fit_all_interarrivals(directory, files_extension, column)
...
for file = files'
    ...
    %Invoke to the fitting function
    [D PD] = allfitdist(dataset);
    %Display the best fitting for this distribution
    disp('--- 1st Fitting ---');
    disp(D(1));
    disp('--- 2nd Fitting ---');
    disp(D(2));
...
%%EXTERNAL FUNCTIONS TO DO THE ACTUAL FITTING
